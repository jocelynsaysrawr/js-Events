...
function valueMenu(){
	for(var i = 0; i < menuItems.length; i++){
		...
		var menuBox = document.createElement("p");
		menuBox.innerHTML = menuItems[i];
...
function showPrice(){
	var oreoPrice = document.getElementById("price");
...
function quote(){
	  var quoteBox = document.getElementById("displayQuote");
	  quoteBox.innerHTML = myQuote;
	  displayQuote.appendChild(quoteBox);
...
console.log(randomQuotes);
	document.getElementById("displayQuotes").innerHTML = quotes[randomQuotes];
}
